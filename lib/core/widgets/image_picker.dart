...
Future<void> pickImage({required Function(XFile image) onImagePicked, required String text}) async {
  Get.bottomSheet(PickImageSheet(onImagePicked: onImagePicked, text: text), isScrollControlled: true);
}

class PickImageSheet extends StatefulWidget {
  final Function(XFile image) onImagePicked;
  final String text;
  const PickImageSheet({super.key, required this.onImagePicked, required this.text});
                    ...
                    if (selectedImage == null)
                      Column(
                        ...
                        children: [
                          ...
                          Text('Upload Image', style: context.font12.copyWith(fontWeight: FontWeight.w500)),
                        ],
                      ),
                  ],
                ),
