...
class BgRemoverAnimation extends StatefulWidget {
  const BgRemoverAnimation({super.key});

  @override
  BgRemoverAnimationState createState() => BgRemoverAnimationState();
}

class BgRemoverAnimationState extends State<BgRemoverAnimation>
              ...
              children: [
                ...
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    double linePosition =
                        (imageWidth / 2) + (_animation.value * imageWidth);
