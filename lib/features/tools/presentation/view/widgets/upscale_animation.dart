...
class UpscaleAnimationState extends State<UpscaleAnimation> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animation = TweenSequence<double>([
      ...
      TweenSequenceItem(tween: Tween(begin: 1.0, end: 0.0), weight: 1), // Back to center
      TweenSequenceItem(tween: Tween(begin: 0.0, end: -1.0), weight: 1), // Move left
      TweenSequenceItem(tween: Tween(begin: -1.0, end: 0.0), weight: 1), // Back to center
