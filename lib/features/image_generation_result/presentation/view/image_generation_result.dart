...
import 'package:matrix_ai/features/image_generation_result/presentation/view/widgets/regenerate.dart';
...
class ImageGenerationResultScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Get initial index
    final initialIndex = historyController.getInitialIndex(result, favorites: favorites);
    ...
    return Scaffold(
      body: PageView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          ImageGenerationResultController.find.imageGenerationResult = currentResponse;
