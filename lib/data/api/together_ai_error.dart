...
TogetherAIError getTogetherAIError(String errorCode, String errorMessage) {
  return switch (errorCode) {
    'invalid_api_key' => AuthenticationError("invalid_api_key"),
    'bad_request' => BadRequest("bad_request"),
    'not_found' => NotFound('not_found'),
    'rate_limit_exceeded' => RateLimitExceeded('rate_limit_exceeded'),
    'model_rate_limit' => RateLimitExceeded('rate_limit_exceeded'),
    'invalid_request' => InvalidRequest('invalid_request'),
    'engine_overloaded' => EngineOverloaded('engine_overloaded'),
    'timeout' => Timeout('timeout'),
    'server_error' => ServerError('server_error'),
    'connection_timeout' => ConnectionTimeout('connection_timeout'),
    _ => UnknownServerError('unknown_error'),
  };
}
