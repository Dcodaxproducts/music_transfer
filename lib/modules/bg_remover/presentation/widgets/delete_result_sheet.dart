...
class DeleteBgRemoverSheet extends StatelessWidget {
  final BgRemoverResult result;
  final bool closeScreen;
  const DeleteBgRemoverSheet({super.key, required this.result, this.closeScreen = true});
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: PrimaryButton(
                    ...
                    color: errorColor,
                    onPressed: () {
                      BgRemoverController.find.removeFromHistory(result);
