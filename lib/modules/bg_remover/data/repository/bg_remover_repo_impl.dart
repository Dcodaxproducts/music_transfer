...
class BgRemoverRepoImpl implements BgRemoverRepo {
  ...
  @override
  Future<Response?> removeImageBackground(Map<String, dynamic> body, MultipartBody multipartBody) async =>
      await apiClient.postMultipart(Endpoints.removeBackground, body, [multipartBody], hideLoading: false);
