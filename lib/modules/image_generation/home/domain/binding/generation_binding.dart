...
import '../service/generation_service_impl.dart';

class GenerationBinding extends Bindings {
  @override
  void dependencies() {
    // repo
    GenerationRepo generationRepoInterface = GenerationRepoImpl(prefs: Get.find());
    Get.lazyPut(() => generationRepoInterface, fenix: true);

    // service
    GenerationService generationServiceInterface = GenerationServiceImpl(generationRepoInterface: Get.find());
