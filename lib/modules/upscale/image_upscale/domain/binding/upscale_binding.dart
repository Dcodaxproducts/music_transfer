...
import 'package:matrix_ai/modules/upscale/image_upscale/domain/service/image_upscale_service_interface.dart';
...
class UpscaleBinding extends Bindings {
  ...
  void dependencies() {
    ...
    ImageUpscaleRepoInterface imageUpscaleRepoInterface =
        ImageUpscaleRepo(apiClient: Get.find(), prefs: Get.find());
