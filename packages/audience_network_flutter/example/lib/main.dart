...
class AdsPage extends StatefulWidget {
  ...
  const AdsPage({super.key, this.idfa = ''});
...
class AdsPageState extends State<AdsPage> {
    ...
    setState(() {
      _currentAd = BannerAd(
        ...
        listener: BannerAdListener(
          onError: (code, message) => debugPrint('banner ad error\ncode: $code\nmessage:$message'),
  ...
  Widget _nativeBannerAd() {
    return NativeAd(
      ...
      listener: NativeAdListener(
        onError: (code, message) => debugPrint('native banner ad error\ncode: $code\nmessage:$message'),
        onLoaded: () => debugPrint('native banner ad loaded'),
  ...
  Widget _nativeAd() {
    return NativeAd(
      ...
      buttonBorderColor: Colors.white,
      listener: NativeAdListener(
        onError: (code, message) => debugPrint('native ad error\ncode: $code\nmessage:$message'),
